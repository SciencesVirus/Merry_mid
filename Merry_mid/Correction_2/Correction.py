...
# 載入圖像
bg_image = cv2.imread("Correction back.png")
yes_img = cv2.imread("yes.png", cv2.IMREAD_UNCHANGED)
no_btn = cv2.imread("no.png", cv2.IMREAD_UNCHANGED)
next_btn = cv2.imread("next.png", cv2.IMREAD_UNCHANGED)
